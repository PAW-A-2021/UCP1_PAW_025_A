...
namespace UCP1_PAW_025_A.Models
{
    public partial class TokoLanggengJayaContext : DbContext
    {
        public TokoLanggengJayaContext()
        {
        }

        public TokoLanggengJayaContext(DbContextOptions<TokoLanggengJayaContext> options)
            : base(options)
        {
        }
