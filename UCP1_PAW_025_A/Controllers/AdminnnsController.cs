...
using UCP1_PAW_025_A.Models;

namespace UCP1_PAW_025_A.Controllers
{
    public class AdminnnsController : Controller
    {
        private readonly TokoLanggengJayaContext _context;

        public AdminnnsController(TokoLanggengJayaContext context)
        {
            _context = context;
        }
